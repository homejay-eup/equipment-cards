  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 sm:px-6">
      ...
      {announcements.length > 0 && (
        <div className="mb-3 rounded-xl border border-[rgba(122,82,48,.25)] bg-[rgba(122,82,48,.07)] px-4 py-3">
          <div className="flex items-center gap-1.5 mb-1.5">
            <Megaphone className="h-4 w-4 text-[#7a5230] shrink-0" />
            <span className="text-sm font-semibold text-[#7a5230]">公佈欄</span>
          </div>
