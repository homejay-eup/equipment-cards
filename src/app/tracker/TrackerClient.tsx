      ...
      <div className="grid grid-cols-4 gap-3 min-w-[700px]">
        {COLUMNS.map(col => {
          ...
          return (
            <div
              key={col.key}
              className={`bg-[#d3c3aa] rounded-xl border shadow-sm flex flex-col transition-colors ${dragOverCol === col.key ? 'border-2 border-[#c49a72]' : 'border border-[rgba(122,82,48,.16)]'}`}
